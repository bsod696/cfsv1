...
-- Dumping data for table cfsv1.orders: ~5 rows (approximately)
...
INSERT INTO `payment_details` (`id`, `parentid`, `fullname`, `billaddr1`, `billaddr2`, `city`, `zipcode`, `state`, `country`, `cardtype`, `cardnum`, `cvvnum`, `expdate`, `defaultpay`, `created_at`, `updated_at`) VALUES
	(1, 17, 'User Satu', '55, Jalan Hang Tuah', 'Taman Cempaka', 'Ipoh', '32050', 'Perak', 'Malaysia', 'visa', '452356835235', '555', '03/21', 'Y', '2019-11-25 23:46:54', '2019-11-26 00:55:12'),
...
-- Dumping data for table cfsv1.staffs: ~8 rows (approximately)
...
-- Dumping data for table cfsv1.student: ~4 rows (approximately)
