...
-- Dumping data for table cfsv1.menus: ~6 rows (approximately)
...
-- Dumping data for table cfsv1.student: ~7 rows (approximately)
...
-- Dumping data for table cfsv1.transaction: ~4 rows (approximately)
