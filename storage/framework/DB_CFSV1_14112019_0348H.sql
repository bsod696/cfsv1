...
INSERT INTO `menus` (`id`, `name`, `desc`, `type`, `allergy_id`, `stock`, `price`, `calories`, `foodpic`, `staffuid`, `created_at`, `updated_at`) VALUES
	...
	(2, 'Mi Goreng Mamak', 'Egg noodles stir-fried with soy sauce, chilli paste. Top it off with tofu and some veggies (mustard and bean sprouts).', 'food', '{2,6}', '30', '2.40', '650', 'https://assets.nst.com.my/images/articles/26ntmee3_1535260361.jpg', '2', '2019-11-10 18:18:16', '2019-11-10 18:21:53'),
...
INSERT INTO `orders` (`id`, `parentid`, `studentid`, `studentname`, `menu_id`, `menu_name`, `menu_date`, `menu_price`, `menu_qty`, `redeem_status`, `redeem_date`, `txid`, `created_at`, `updated_at`) VALUES
	(4, '17', 'SC001', 'Student Satu bin Parent Satu', '1', 'Nasi Lemak Telur Rebus', '2019-11-10 17:54:58', '2.50', '3', 'NOTREDEEEMED', NULL, '', '2019-11-14 03:15:30', '2019-11-14 03:46:40'),
	(5, '17', 'SC002', 'Student Dua', '3', 'Rose Syrup ', '2019-11-10 18:28:41', '1.00', '3', 'NOTREDEEEMED', NULL, '', '2019-11-14 03:32:05', '2019-11-14 03:46:48');
...
INSERT INTO `student` (`id`, `fullname`, `studentid`, `primary_parentid`, `secondary_parentid`, `class`, `school_session`, `dob`, `age`, `height`, `weight`, `gender`, `bmi`, `target_calories`, `created_at`, `updated_at`) VALUES
	(3, 'Student Satu bin Parent Satu', 'SC001', '17', '', '1A', 'morning', '2009-07-14', '10', '150', '80', 'male', '35.6', '2004', '2019-11-10 14:35:09', '2019-11-14 02:27:24'),
	(5, 'Student Dua', 'SC002', '', '17', '4A', 'afternoon', '2011-10-13', '8', '165', '55', 'female', '20.2', '3200', '2019-11-10 14:51:18', '2019-11-10 17:03:37');
