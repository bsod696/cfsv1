...
-- Dumping data for table cfsv1.allergy: ~9 rows (approximately)
...
-- Dumping data for table cfsv1.months: ~12 rows (approximately)
...
-- Dumping data for table cfsv1.student: ~6 rows (approximately)
...
INSERT INTO `student` (`id`, `fullname`, `studentid`, `primary_parentid`, `secondary_parentid`, `class`, `school_session`, `dob`, `age`, `height`, `weight`, `gender`, `bmi`, `target_calories`, `allergies`, `created_at`, `updated_at`) VALUES
	(3, 'Student Satu bin Parent Satu', 'SC001', '17', NULL, '1A', 'morning', '2009-07-14', '10', '155', '55', 'male', '22.9', '2533', 'a:9:{s:9:"shellfish";b:0;s:5:"dairy";b:0;s:7:"peanuts";b:1;s:8:"treenuts";b:1;s:4:"eggs";b:0;s:5:"wheat";b:0;s:3:"soy";b:0;s:4:"fish";b:0;s:9:"noallergy";b:0;}', '2019-11-10 14:35:09', '2019-11-27 16:50:46'),
...
INSERT INTO `users` (`id`, `username`, `fullname`, `phonenum`, `usrrole`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	...
	(20, 'bsod666', 'Hariz', '01126379781', 'parent', 'muhammedharizzubir@gmail.com', NULL, '$2y$10$1dtZK22SdsifczBGakCN0un7KyLP6kSf/9qL2ZHNt/Rfu2dCuN4hO', '4smUqJ49kwz3kk0KnPhrFDpqU5ZyyLCnQD9ZhwLtO3BcuKJJF9VBVaXPTYHh', '2019-11-27 00:46:23', '2019-11-27 16:02:25');
...
-- Dumping data for table cfsv1.years: ~0 rows (approximately)
