...
-- Dumping data for table cfsv1.menus: ~7 rows (approximately)
...
-- Dumping data for table cfsv1.orders: ~9 rows (approximately)
...
INSERT INTO `orders` (`id`, `parentid`, `studentid`, `studentname`, `menuid`, `menuname`, `menudate`, `menuprice`, `menuqty`, `redeemstatus`, `redeemdate`, `txid`, `staffid`, `created_at`, `updated_at`) VALUES
	(4, '17', 'SC001', 'Student Satu bin Parent Satu', '1', 'Nasi Lemak Telur Rebus', '2019-12-06 17:54:58', '2.50', '3', 'NOTREDEEEMED', '2019-12-03 19:47:04', 'CFSP17D4H1573758074TXDRW12', '1', '2019-11-14 03:15:30', '2019-12-05 00:32:39'),
	...
	(15, '20', 'SC004', 'Park Chae Young', '7', 'Lemonade', '2019-12-09 00:00:00', '1.00', '1', 'NOTREDEEEMED', NULL, '', '1', '2019-12-06 01:13:53', '2019-12-08 02:54:21'),
	...
	(18, '20', 'SC006', 'Song Ji Hyo', '5', 'Keria', '2019-12-11 00:00:00', '0.40', '2', 'NOTREDEEEMED', NULL, '', '', '2019-12-09 01:09:37', '2019-12-09 01:09:37');
...
INSERT INTO `staffs` (`id`, `username`, `fullname`, `phonenum`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'staff1', 'Saadiah binti Ahmad Jusoh', '0168859966', 'staff.satu@gmail.com', NULL, '$2y$10$iUYcbpBK0ikwmpj9V8kqPeguXcWtYJVk.Dd1ad7o5dPVYNE9D3rLu', NULL, '2019-11-09 13:50:08', '2019-12-09 01:28:44'),
...
INSERT INTO `student` (`id`, `fullname`, `studentid`, `parentid`, `class`, `school_session`, `dob`, `age`, `height`, `weight`, `gender`, `bmi`, `target_calories`, `allergies`, `created_at`, `updated_at`) VALUES
	...
	(11, 'Nur Jamiah Binti Muhammed Hariz', 'SC0012', '20', '2A', 'morning', '2010-12-15', '8', '142', '45', 'female', '22.3', '2100', 'a:9:{s:9:"shellfish";b:0;s:5:"dairy";b:0;s:7:"peanuts";b:0;s:8:"treenuts";b:0;s:4:"eggs";b:0;s:5:"wheat";b:0;s:3:"soy";b:0;s:4:"fish";b:0;s:9:"noallergy";b:1;}', '2019-11-27 14:43:38', '2019-11-27 16:53:43'),
...
-- Dumping data for table cfsv1.transaction: ~7 rows (approximately)
/*!40000 ALTER TABLE `transaction` DISABLE KEYS */;
INSERT INTO `transaction` (`id`, `menuid`, `parentid`, `paymentid`, `orderid`, `txstatus`, `txreference`, `txamount`, `txid`, `created_at`, `updated_at`) VALUES
	...
	(3, '3', '17', '1', '8', 'success', 'PAYORDERS', '0.00', 'CFSP17D8P1H1575396711TXOAFGI', '2019-12-04 02:11:51', '2019-12-04 02:11:51'),
	(4, '4', '17', '1', '12', 'success', 'PAYORDERS', '0.00', 'CFSP17D12P1H1575396721TXBZNOG', '2019-12-04 02:12:01', '2019-12-04 02:12:01'),
	(5, '2', '17', '1', '11', 'success', 'PAYORDERS', '0.00', 'CFSP17D11P1H1575396764TX1NWBH', '2019-12-04 02:12:44', '2019-12-04 02:12:44'),
	(6, '6', '20', '3', '13', 'success', 'PAYORDERS', '0.00', 'CFSP20D13P3H1575755532TX6PHAL', '2019-12-08 05:52:12', '2019-12-08 05:52:12'),
	(7, '8', '20', '4', '16', 'success', 'PAYORDERS', '0.00', 'CFSP20D16P4H1575755543TXNYBLK', '2019-12-08 05:52:23', '2019-12-08 05:52:23'),
	(8, '3', '20', '3', '17', 'success', 'PAYORDERS', '0.00', 'CFSP20D17P3H1575755552TX6KASS', '2019-12-08 05:52:32', '2019-12-08 05:52:32');
...
INSERT INTO `users` (`id`, `username`, `fullname`, `phonenum`, `usrrole`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	...
	(20, 'bsod666', 'Muhammed Hariz bin Sulaiman', '01126379781', 'parent', 'muhammedharizzubir@gmail.com', NULL, '$2y$10$1dtZK22SdsifczBGakCN0un7KyLP6kSf/9qL2ZHNt/Rfu2dCuN4hO', 'YntOk7i9jrsBopAKYPuh2z6Z1Xjh42BmqCE0i1Ej1pzwWD4gDv0OXJMOpJ0C', '2019-11-27 00:46:23', '2019-12-09 01:27:07');
