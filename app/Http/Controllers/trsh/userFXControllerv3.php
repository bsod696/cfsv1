...
class userFXControllerv3 extends Controller
{
...
//---------------------------------------------------------------------------------------------------------------------------------------------//
	...
	public function updateimgacc1(){
   	...
   	public function updateimgacc1Proc(Request $request){
		...
		echo "<br />Account Statement for Bank1 Updated<br /";
		return redirect('/viewsubmit');
	}
//---------------------------------------------------------------------------------------------------------------------------------------------//
	...
	public function updateimgself(){
   	...
   	public function updateimgselfProc(Request $request){
		...
		echo "<br />Selfie Image Updated<br /";
		return redirect('/viewsubmit');
	}
//---------------------------------------------------------------------------------------------------------------------------------------------//
    //Verify user data in block
    public function verifydocs(){return view('user.formverifydocsv3');}
