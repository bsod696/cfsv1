            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('user.submit.storepayment') }}">
                        ...
                        <input id="fullname" type="hidden" class="form-control @error('fullname') is-invalid @enderror" name="fullname" value="{{ $u->fullname }}" readonly autocomplete="fullname" autofocus>
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cvvnum" type="text" class="form-control @error('cvvnum') is-invalid @enderror" name="cvvnum" value="{{ old('cvvnum') }}" required autocomplete="cvvnum" autofocus>
