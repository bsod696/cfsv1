...
<div class="box">
                    ...
                    <form method="POST" action="{{ route('staff.submit.password') }}">
                        @csrf

                        <div class="row gtr-50 gtr-uniform">

                            <input id="id" type="hidden" class="form-control{{ $errors->has('id') ? ' is-invalid' : '' }}" name="id" value="{{ Auth::guard('staff')->user()->id }}" readonly>
