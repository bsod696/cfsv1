                    ...
                    <form method="POST" action="{{ route('admin.submit.storepayment') }}">
                        ...
                        <div class="row gtr-50 gtr-uniform">
                            ...
                            <div class="col-6 col-12-mobilep">
                                ...
                                <input id="cardnum" type="number" class="form-control @error('cardnum') is-invalid @enderror" name="cardnum" value="{{ old('cardnum') }}" required autocomplete="cardnum" autofocus>
                            ...
                            <div class="col-6 col-12-mobilep">
                                ...
                                <input id="cvvnum" type="number" maxlength="3" class="form-control @error('cvvnum') is-invalid @enderror" name="cvvnum" value="{{ old('cvvnum') }}" required autocomplete="cvvnum" autofocus>
